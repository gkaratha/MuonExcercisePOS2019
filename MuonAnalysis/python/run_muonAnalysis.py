...
Nentries=100000;  output="output_Data_valnew.root"; 
nlog=100
MuPtMin=1.0; MuMu=dict(MinM=2.2,MaxM=5,PtMin=0,Vtx=True);
SkipEvtWithNoFire=False; SkipEvtWithNoVtx=False;
File=[
'/store/data/Run2018C/ParkingBPH5/MINIAOD/05May2019-v1/100000/FFC3D9DD-BD25-894B-88A2-C3A0C45F07DA.root'
]
############
...
process.demo = cms.EDAnalyzer('MuonAnalysisb',
      ...
      ReconstructMuMuVtx=cms.bool(MuMu["Vtx"]), 
      McutMin=cms.double(MuMu["MinM"]),McutMax=cms.double(MuMu["MaxM"]),
      PtMuMuCut=cms.double(MuMu["PtMin"]),SkipEvtWithNoVtx=cms.bool(SkipEvtWithNoVtx)
