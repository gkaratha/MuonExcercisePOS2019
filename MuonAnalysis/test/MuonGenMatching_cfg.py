...
process.TFileService = cms.Service("TFileService",
                                    fileName = cms.string('muonGenmatching.root')
)

process.load('POS2019.MuonAnalysis.MuonGenMatching_cfi')
                    
process.p = cms.Path(process.selectedPrimaryVertices*process.muonGenMatching)
