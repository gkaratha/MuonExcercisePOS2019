...
process = cms.Process('TnPMCtruthAnalysis')
...
process.TFileService = cms.Service("TFileService",
                                    fileName = cms.string('muonTnPmctruth.root')
)

process.load('POS2019.MuonAnalysis.MuonTnPMCtruth_cfi')
                    
process.p = cms.Path(process.selectedPrimaryVertices*process.muonTnPmctruth)
